...
| [R1](claims/R1-relativity-no-global-commit-order.md) | conjecture | open | Relativity is naturally compatible with no universal global finality order; T42 separates local accumulation from record-access lag, T43 identifies finite local mechanisms, T44 shows demand/coupling probes can distinguish those mechanisms without deriving proper time, T46 distinguishes open causal access gradients from closed synchronization boundaries, and T151 adds the guardrail that remote observation through received signals is ordinary causal record access while direct local participation is a stronger relation. | [T3](tests/T3-spacelike-events-no-global-commit-order.md), [T7](tests/T7-overlapping-causal-domains.md), [T42](tests/T42-local-persistence-reconciliation-split.md), [T43](tests/T43-local-persistence-mechanisms.md), [T44](tests/T44-local-mechanism-identifiability.md), [T46](tests/T46-open-causal-scarcity-synchronization-boundary.md), [T151](tests/T151-causal-access-screen.md) |
| [B1](claims/B1-black-holes-finality-boundaries.md) | potential_byproduct | weakened | Black holes remain useful stress tests for finality-domain boundaries only in the narrowed direct-classical-record sense: T151 shows the current B1 content factors through ordinary causal reachability/domain-of-dependence bookkeeping and is translation residue until a non-reachability capability is typed. | [T4](tests/T4-black-hole-causal-access-boundary.md), [T7](tests/T7-overlapping-causal-domains.md), [T151](tests/T151-causal-access-screen.md) |
| [S1](claims/S1-spacetime-consensus-envelope.md) | speculative_extension | open_formal_target | Spacetime may be the compatibility structure produced by aggregating observer-local finality domains; T16 gives a finite gluing target but not a spacetime derivation, and T151 requires any future S1 aggregation to carry causal-access maps, channel types, and boundary permeability rather than only compatible local orders. | [Rendered interface](open-problems/rendered-interface-assumptions.md), [Spacetime colimit](open-problems/spacetime-as-finality-colimit.md), [T7](tests/T7-overlapping-causal-domains.md), [T16](tests/T16-spacetime-aggregation.md), [T151](tests/T151-causal-access-screen.md) |
