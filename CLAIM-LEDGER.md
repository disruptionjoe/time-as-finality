...
| [TF1](claims/TF1-typed-forgetting-attribution.md) | formal_target | open_formal_target | Typed Forgetting Attribution: a projection-created obstruction is admissibly attributable only when the projection carries a typed loss object naming structure that resolves the obstruction in the source. T99 weakens label-only LossKernel: same endpoints, ordinary composite map, endpoint behavior, and naive lost-label set can still require opposite attribution verdicts unless LossKernel carries source-anchored witness obligations. This is a conditional salvage path, not theorem-level support. | [Loss Kernel Formalization](open-problems/loss-kernel-formalization.md), [T34](tests/T34-po1-chained-projection.md), [T37](tests/T37-typed-transport-network.md), [T39](tests/T39-csp-satisfiability-reframing.md), [T40](tests/T40-holarchy-lab.md), [T41](tests/T41-typed-transport-category.md), [T99](tests/T99-losskernel-quotient-separation.md) |
