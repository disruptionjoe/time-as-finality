...
- T30 keeps PO1 `partially_supported` but constrained after hostile
  non-physics validation: Git positive, database and access-control negative
  controls, type-system non-definable boundary.
