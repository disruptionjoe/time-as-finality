...
- **T523 claim-ledger frontier audit - no row.** The executable audit verifies
  that the registry is at T524, the still-untriaged frontier is T249-T513, T517-T519
  are already no-row DS-bridge prospecting, T521-T523 are infrastructure/no-row
  artifacts, T524 is S1 diagnostic repair with no status movement, and neither
  T523 nor T524 creates a claim row.
