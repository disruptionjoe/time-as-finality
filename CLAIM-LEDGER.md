...
- **Finite-witness supported** (real evidence on small hand-built cases; no general proof): D1-Field, IPT, PO1, CSP-PO1, HEF, TTN, MMT, H1-Sheaf, MTI, A1, RSPS, R1. *Includes the FinaliEvent spine's interesting temporal content — the Anti-Scalar result (T49/T50), observer-colimit repair (T51/T52) — confirmed only on 3–8-element witnesses.*
