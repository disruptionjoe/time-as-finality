...
| --- | --- | --- | --- | --- |
| [C1](claims/C1-experienced-time-as-record-finality.md) | core_claim | weakened | Accessible stabilization frontiers can reconstruct an observer-relative temporal partial order; total and phenomenal readings are unsupported; T17 internalizes a minimal reconciler but does not model experience. | [T1](tests/T1-record-graph-temporal-reconstruction.md), [T17](tests/T17-persistent-dynamical-reconciler.md) |
| [C2](claims/C2-typed-compositional-finality.md) | core_claim | weakened | Evidence may compose by provenance-preserving join, while inherited expression, access, profiles, coarse-graining, proof validation, confidence, signed dynamics, write status, and decisions need not preserve that algebra. | [T11](tests/T11-compositional-finality.md), [T14](tests/T14-integrated-observer-context-finality.md), [T15](tests/T15-generated-integrated-finality-stress.md), [T16](tests/T16-dynamical-phase-bearing-records.md), [T17](tests/T17-persistent-dynamical-reconciler.md) |
...
| [D1](claims/D1-physical-finality-definition.md) | definition | weakened | Finality is an observer-indexed comparative schema; T13-T16 show its profile is not a complete phase-sensitive readout, proof, or consensus state; T17 computes profiles over internally stored records. | [FORMALISM](FORMALISM.md), [T1](tests/T1-record-graph-temporal-reconstruction.md), [T5](tests/T5-thermodynamic-record-support.md), [T9](tests/T9-emergence-laboratory.md), [T10](tests/T10-proof-carrying-metastable-finality.md), [T11](tests/T11-compositional-finality.md), [T13](tests/T13-signed-interfering-readout.md), [T14](tests/T14-integrated-observer-context-finality.md), [T15](tests/T15-generated-integrated-finality-stress.md), [T16](tests/T16-dynamical-phase-bearing-records.md), [T17](tests/T17-persistent-dynamical-reconciler.md) |
| [D2](claims/D2-observer-as-record-bearing-system.md) | definition | revised | T1 distinguishes capabilities; T12 makes coupling explicit; T14-T15 combine observer parameters; T17 internalizes a minimal reconciler subsystem. | [T1](tests/T1-record-graph-temporal-reconstruction.md), [T10](tests/T10-proof-carrying-metastable-finality.md), [T11](tests/T11-compositional-finality.md), [T12](tests/T12-coupling-profile-reconstruction.md), [T13](tests/T13-signed-interfering-readout.md), [T14](tests/T14-integrated-observer-context-finality.md), [T15](tests/T15-generated-integrated-finality-stress.md), [T17](tests/T17-persistent-dynamical-reconciler.md), [N3](literature/N3-core-formalism-known-neighbors.md) |
...
### 2026-06-16 - Persistent dynamical reconciler

- T17 implements a finite local-update reconciler with sensors, persistent
  memory, explicit written flags, and an internal comparator.
- D2 is strengthened narrowly: a reconciler can be represented as an internal
  subsystem rather than only as a selected terminal observer window.
- D1 and C2 remain limited: stored value, write status, access boundary,
  finality profile, and decision remain distinct typed components.
