# Candidate North Star v0.4: Projection Sufficiency For Typed Capability
...
This version compresses v0.3 into an audit specification. Long prior-art
inventories, database taxonomies, mathematics perspectives, and physics
persona reports remain companion artifacts.
...
A typed distinction survives immediate prior-art absorption as a clean formal
...
The strongest v0.4 formulation is:
