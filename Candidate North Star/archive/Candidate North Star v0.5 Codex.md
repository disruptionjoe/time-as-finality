# Candidate North Star v0.5 Codex: Projection Sufficiency For Typed Capability
...
This Codex version is a compact v0.5 patch over v0.4. It preserves the audit
specification while adding explicit equality, approximate-equivalence,
domain-calibration, falsifiability, and appendix-navigation guardrails.

Long prior-art inventories, database taxonomies, mathematics perspectives, and
physics persona reports remain companion artifacts.
...
The default visible-state equality relation is not:
...
object, lemma, quotient, metric, or audit criterion, but canonicity is not yet
established.
...
Use compact domain calibration in the main note.
...
| `Database Absorption Test for Capability Projection-deep-research-report.md` | Database absorption map, view/query determinacy framing, provenance/index/MVCC/access-control/retrieval equality fields. |
| `Prior-Art Audit of Capability Projection-deep-research-report.md` | Broad absorption posture across decision theory, process semantics, abstraction, POMDPs, resource theory, causal inference, and control. |
| `Prior Art And Physics Grounding For Capability Projection - Deep Research.md` | Prior-art and physics grounding, with raw-citation cleanup still needed before polished use. |
| `Candidate North Star Mathematical Strengthening Suggestions v0.1.md` | Mathematical strengthening suggestions: factorization spine, minimal quotients, enrichment controls, capability spread, and physics-safe formalization. |
| `Candidate North Star 20 Mathematics Perspectives Report v0.1.md` | Twenty mathematics lenses, cross-cutting weak points, and hardening moves. |
| `Candidate North Star 20 Physics Perspectives Report v0.1.md` | Twenty physics lenses, no-free-physics requirements, access-profile discipline, and strong/weak physics witness families. |
| `Candidate North Star Low-Hanging Dispatch Synthesis v0.1.md` | Synthesis of accepted low-hanging formal, physics, and editorial patches from the v0.4 transition. |
| `Fresh-Eyes Review Candidate North Star v0.4.md` | Review that forced quotient/equivalence cleanup and local-access physics warning into v0.4. |
| `Pre-v0.5 Review Report v0.1.md` | Queue-item verdicts on Q1-Q12 and initial v0.5 patch recommendations. |
| `Pre-v0.5 Readiness Action Report v0.1.md` | Codex readiness pass consolidating main-note patches, companion work, navigation checks, and source-hygiene concerns. |

The main note should stay compact enough to function as a reviewable audit
specification.

## Current Best Formulation

The strongest v0.5 Codex formulation is:
