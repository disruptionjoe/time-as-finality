...
| [T377](tests/T377-relativistic-record-rendering-fixture.md) | Relativistic record rendering fixture | D1, R1, S1, PO1 | implemented/verdict calibration: a finite no-time-column u/v carrier renders two observer coordinate histories with simultaneity disagreement and a shared interval-like invariant, but fixed-schema and fixed-completed-table absorbers still fire; no claim upgrade. models/relativistic_record_rendering.py, tests/test_relativistic_record_rendering.py (7 passed), results/relativistic-record-rendering-v0.1-results.md |
