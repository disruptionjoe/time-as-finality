...
| [T187](tests/T187-moses-exact-constrained-optimization.md) | Moses exact constrained optimization | MTI, Cap_TI, T186 | implemented: T186 open blocker resolved; exact harmonic-mean Moses formula gives beta_exact(Alpha)=0.6651 and beta_exact(Beta)=0.6941 for T186 fixtures with identical causal order; beta_exact(Beta) > beta_exact(Alpha) CONFIRMED; formula beta = 1 - log(harmonic_mean(T)) / log(n) derived from KKT conditions for flow-conservation minimization; sign agrees with CV approximation; see results/T187-moses-exact-constrained-optimization-v0.1-results.md |
...
- [T187 Moses Exact Constrained Optimization v0.1 Results](results/T187-moses-exact-constrained-optimization-v0.1-results.md)
