...
test, common in the generated T15 sweep, and strengthened by T16's
dynamically derived signs.
...
[T16](../tests/T16-dynamical-phase-bearing-records.md) derives signed weights
from elementary-cellular-automaton trace direction. It finds the same profile
`(2,2,1,2)` with dynamically generated readouts `0.0` and `4.0`.
...
Extend T16 from `+1/-1` direction signs to richer phase classes or complex
amplitudes generated by local reversible dynamics.
