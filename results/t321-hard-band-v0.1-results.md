# T321 Results: Hard Band

## Aggregate Checks

| Metric | Value |
| --- | --- |
| `description` | `Hard gate: T126 plus T156 band.` |
| `total_weight` | `143435` |
| `tail_weight` | `10` |
| `tail_probability` | `{'fraction': '2/28687', 'float': 6.971799072750723e-05}` |
| `parentcap_probability` | `{'fraction': '66/143435', 'float': 0.00046013873880154774}` |
| `selected_probability` | `{'fraction': '1/143435', 'float': 6.9717990727507235e-06}` |
| `lift_vs_uniform` | `{'fraction': '72576/28687', 'float': 2.5299264475197827}` |
| `uses_tail_label` | `False` |
| `empirical_target_equivalent` | `False` |
| `uses_deletion_t252_count` | `False` |

- Verdict: `hard_band_tail_probability_recorded`

## Strongest Claim

The `hard_band` candidate assigns the 10-case tail probability 2/28687.
...
T321 fails if the `hard_band` weights are changed without renaming the measure.
...
Do not update the claim ledger from T321 alone.
