...
# Explore Family — Memory Pack (load surface)
...
- **Purpose.** Carry durable, compact guidance for the **explore** family so its
  workflows improve across runs without re-reading raw history.
- **Scope.** The explore family: `line-discovery`, `line-incubation`,
  `foundation-ingestion`, `cross-disciplinary-synthesis`, `landscape-reassessment`,
  `persona-expansion`. Recurring lessons, heuristics, anti-patterns, and failure
  modes specific to expanding and searching the idea landscape accumulate here.
...
|---|---|---|---|
| _example_ | _(e.g. "Cross-disciplinary candidates with no testable consequence belong in incubation, not discovery.")_ | _none — illustrative_ | _example_ |
